...
export async function main(start_date: string, end_date: string, merchant_id?: string) {
  ...
  return reconcilePayments(storeOrders, normalizeLusopayPayments(rawPayments));
}
