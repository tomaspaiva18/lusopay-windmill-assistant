...
const required = [
  ...
  'f/lusopay/criar_link_pagamento.ts',
  'f/lusopay/acompanhar_pagamento.ts',
  'f/lusopay/receber_callback_pagamento.ts',
  'lib/merchant_context.ts',
  'lib/lusopay_client.ts',
  'lib/payment_normalizer.ts',
  'lib/payment_registry.ts',
  'lib/store_client.ts',
  'lib/reconcile.ts',
  ...
  'lusopay/criar_link_pagamento.ts',
  'lusopay/acompanhar_pagamento.ts',
  'lusopay/receber_callback_pagamento.ts',
  ...
  'scripts/mcp-call-tool.mjs',
  'scripts/hash-merchant-token.mjs',
  'local-chat/server.mjs',
  'local-chat/public/index.html',
